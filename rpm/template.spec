...
%global pkg_name depthimage_to_laserscan
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-depthimage-to-laserscan
Version:        2.5.1
Release:        4%{?dist}
...
%changelog
* Wed Apr 29 2026 Chris Lalancette <clalancette@openrobotics.org> - 2.5.1-4
- Autogenerated by Bloom

* Tue Apr 28 2026 Chris Lalancette <clalancette@openrobotics.org> - 2.5.1-3
- Autogenerated by Bloom

* Tue Apr 21 2026 Chris Lalancette <clalancette@openrobotics.org> - 2.5.1-2
- Autogenerated by Bloom
